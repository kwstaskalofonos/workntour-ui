...
import DatePickerArray from "@src/components/DatePicker";
...
const AddOpportunityTab: React.FunctionComponent = () => {
  ...
  const [selectedLearningOpps, setSelectedLearningOpps] = useState<
    LearningOpportunities[]
  >([]);
  const [opportunityLocation, setOpportunityLocation] =
    useState<OpportunityLocation>();
  const [opportunityDateRange, setOpportunityDateRange] =
    useState<OpportunityDates>();
  const [images, setImages] = useState<File[]>([]);
  const [startDate, setStartDate] = useState<Date>();
  const [endDate, setEndDate] = useState<Date>();
  const [date, setDate] = useState<any>({ from: null, to: null });
  const [datesArray, setDatesArray] = useState<any>([{ from: null, to: null }]);
  ...
  const renderCategories = () => {
    ...
    for (const item in OpportunityCategory) {
      array.push(
        <option
          key={"category-option-" + item}
          value={item}
          label={OpportunityCategory[item as OpportunityCategoryType]}
        >
          {OpportunityCategory[item as OpportunityCategoryType]}
        </option>
      );
    }
    return array;
  ...
  const renderLanguages = () => {
    ...
    for (const item in Languages) {
      array.push(
        <option
          key={"language-option-" + item}
          value={item}
          label={Languages[item as LanguagesType]}
        >
          {Languages[item as LanguagesType]}
        </option>
      );
    }
    return array;
  ...
  const renderMeals = () => {
    ...
    for (const item in Meal) {
      array.push(
        <option
          key={"meal-option-" + item}
          value={item}
          label={Meal[item as MealType]}
        >
          {Meal[item as MealType]}
        </option>
      );
    }
    return array;
  ...
  const renderLearningOpportunities = () => {
    ...
    for (const item in LearningOpportunities) {
      array.push(
        <option
          key={"learn-opps-option-" + item}
          value={item}
          label={LearningOpportunities[item as LearningOpportunitiesType]}
        >
          {LearningOpportunities[item as LearningOpportunitiesType]}
        </option>
      );
    }
    return array;
  ...
  const renderAccommodation = () => {
    ...
    for (const item in Accommodation) {
      array.push(
        <option
          key={"accommodation-option-" + item}
          value={item}
          label={Accommodation[item as AccommodationType]}
        >
          {Accommodation[item as AccommodationType]}
        </option>
      );
    }
    return array;
  ...
  const onSubmit = (data: Opportunity) => {
    ...
    if (opportunityDateRange) {
      data.opportunityDates = [...datesArray];
    ...
    setIsLoading(true);
    createOpportunityWeb(formData, setIsLoading).then(() => {
  ...
  return (
    <form>
      <div className="columns is-centered opportunities p-4">
        <div className="column is-4">
          ...
          <div className="field">
            ...
            <input
              className="input border-linear has-text-primary"
              type="text"
              {...register("jobTitle", { required: true })}
              placeholder="Type Job Title"
            />
            {errors.jobTitle && (
              <p className={"help is-danger"}>Job Title is required.</p>
            )}
          </div>
          {/*Job Description*/}
          <div className="field">
          ...
          <div className="field">
            ...
            <p className="help is-primary mb-2">
              The images you upload should be in high resolution.Like that your
              traveler will be willing to approach you! It is important to
              include photos of your property, the accommodation that you will
              be providing to travelers and anything else that will make your
              opportunity attractive to travelers.
              <br />
              Please do not include pictures that show the name of your Business
              or Property, as they will be removed.
            </p>
          ...
          <div className="field">
            ...
            <CustomSelectMultiple
              placeholder={"Select types of help"}
              field={"typeOfHelpNeeded"}
              register={register}
              options={renderTypesOfHelp()}
              enumType={TypeOfHelpNeeded}
              selectedValues={selectedHelps}
              setSelectedValues={setSelectedHelps}
            />
          </div>
          {/*location*/}
          <div className="field">
        ...
        <div className="column is-4">
          ...
          <div className="field">
            ...
            <DatePickerArray
              ...
              setDatesArrayCallback={setDatesArray}
            />
            {/* <CustomDateRangeInput
              setDateRange={setOpportunityDateRange}
              resetEndData={false}
              startDate={startDate}
          ...
          <div className="field">
            <label className="label has-text-primary has-text-weight-medium">
              7.Setup working days & hours pes week* max(32)
            </label>
            <div className="is-flex is-justify-content-space-between">
              <input
                className="input border-linear has-text-primary mx-2"
                type="number"
                placeholder="Min Days"
                {...register("minimumDays", { required: true, min: 1 })}
              />
              <input
                className="input border-linear has-text-primary mx-2"
                type="number"
                placeholder="Max Days"
                {...register("maximumDays", { required: true, min: 1 })}
              />
              <input
                className="input border-linear has-text-primary mx-2"
                type="number"
                placeholder="Total hours"
                {...register("totalWorkingHours", { required: true, min: 1 })}
              />
            </div>
            {errors.minimumDays && (
              <p className={"help is-danger"}>Not valid minimum days.</p>
            )}
            {errors.maximumDays && (
              <p className={"help is-danger"}>Not valid maximum days.</p>
            )}
            {errors.totalWorkingHours && (
              <p className={"help is-danger"}>
                Not valid total working hours days.
              </p>
            )}
          </div>
          {/*Languages Required*/}
          <div className="field">
            ...
            <CustomSelectMultiple
              ...
              field={"languagesRequired"}
              register={register}
              options={renderLanguages()}
              enumType={Languages}
              selectedValues={languagesRequired}
              setSelectedValues={setLanguagesRequired}
            />
          </div>
          {/*Languages Spoken*/}
          <div className="field">
            ...
            <CustomSelectMultiple
              ...
              setSelectedValues={setLanguagesSpoken}
            />
          </div>
          {/*Accommodation Provided*/}
          <div className="field">
            <label className="label has-text-primary has-text-weight-medium">
              9.Accommodation Provided*
            </label>
            <div className="control">
              <div className="select is-fullwidth">
                <select
            ...
            {errors.accommodation && (
              <p className={"help is-danger"}>Accommodation is required.</p>
            )}
          </div>
          {/*Meals*/}
          <div className="field">
            ...
            <CustomSelectMultiple
              ...
              setSelectedValues={setSelectedMeals}
            />
          </div>
          {/*Learning Opportunities*/}
          <div className="field">
            <label className="label has-text-primary has-text-weight-medium">
              11.Add the learning opportunities* that the travelers will benefit
              from while working and living with you.
            </label>
            <CustomSelectMultiple
              placeholder={"Select learning opportunities"}
              field={"learningOpportunities"}
              register={register}
              options={renderLearningOpportunities()}
              enumType={LearningOpportunities}
              selectedValues={selectedLearningOpps}
              setSelectedValues={setSelectedLearningOpps}
            />
          </div>
