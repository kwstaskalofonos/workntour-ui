          ...
          >
            ...
            >
              ...
              <p className={"is-size-7 has-text-primary"}>
                <span>
                  <img src={msg} width={12} height={12} />
                </span>
                &nbsp;&nbsp;Email:{" "}
                <a href="mailto: info@workntour.com">info@workntour.com</a>
              </p>
              <p className={"is-size-7 has-text-primary"}>
                <span>
                  <img src={tel} width={12} height={12} />
                </span>
                &nbsp;&nbsp;Phone:{" "}
                <a href="tel:+306986625831">+30 6986625831</a>
              </p>
              <p className={"is-size-7 has-text-primary"}>
                <span>
                  <img src={pin} width={12} height={12} />
                </span>
                &nbsp;&nbsp;Athens, Greece
              </p>
            </div>
      ...
      <div className={"is-flex is-justify-content-center"}>
        <div className={"column is-three-quarters"}>
          ...
          >
            ...
            <div
              className={
                isMobile ? "column is-narrow has-text-centered " : "is-flex"
              }
            >
              <p className={"has-text-weight-bold m-3"}>
                Supported by: &nbsp;&nbsp;
              </p>
