                    ...
                    <div className={"columns is-centered"}>
                        ...
                        <div className={"column is-4"}>
                            ...
                            <div className={"field"}>
                                ...
                                <div className={"is-flex"}>
                                    <div className="field checkBoxWithLabel">
                                        <input className="profileCheckbox" id="dietary1" type="checkbox"
                                               name="dietary1" checked={true}/>
                                        <label htmlFor="dietary1">None</label>
                                    </div>
                                    <div className="field checkBoxWithLabel">
                                        <input className="profileCheckbox" id="dietary2" type="checkbox"
                                               name="dietary2" />
                                        <label htmlFor="dietary2">Vegan</label>
                                    </div>
                                    <div className="field checkBoxWithLabel">
                                        <input className="profileCheckbox" id="dietary3" type="checkbox"
                                               name="dietary3" />
                            ...
                            <div className={"field"}>
                                ...
                                <div className={"is-flex"}>
                                    <div className="field checkBoxWithLabel">
                                        <input className="profileCheckbox" id="driver1" type="checkbox"
                                               name="driver1" checked={true}/>
                                        <label htmlFor="driver1">Yes</label>
                                    </div>
                                    <div className="field checkBoxWithLabel">
                                        <input className="profileCheckbox" id="driver2" type="checkbox"
                                               name="driver2" />
