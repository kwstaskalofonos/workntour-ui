...
const SelectRegistrationModal: React.FunctionComponent<Props> =
  forwardRef<SelectRegistrationModalHandler>(
    (props, ref: React.Ref<SelectRegistrationModalHandler>) => {
      ...
      return (
        <div className={"modal p-5 " + (isActive ? "is-active" : "")}>
          ...
          <div className="modal-card">
            ...
            <section className="modal-card-body">
              <p className={"subtitle"}>Would you like to sign up as a</p>
              <div className={"columns is-centered"}>
                <div className={"column is-4"}>
                  <button
                    className="button is-primary is-fullwidth"
                    onClick={() => goToTravelerRegPage()}
                  >
                    Traveler
                  </button>
                </div>
