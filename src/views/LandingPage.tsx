    ...
    return (
      <React.Fragment>
        <p
          ...
          style={{ color: "#383350" }}
        >
          Find experts from all over
        </p>
        <p
          className="is-size-4 has-text-weight-medium"
          style={{ color: "#383350" }}
        >
          the world & share your culture!
        </p>
        <p
          className="is-size-6 has-text-weight-medium mt-2"
          style={{ color: "#7060E1" }}
        >
          Receive help from enthusiastic
        </p>
        <p
          className="is-size-6 has-text-weight-medium"
          style={{ color: "#7060E1" }}
        >
          travelers, provide accommodation and
        </p>
        <p
          className="is-size-6 has-text-weight-medium"
          style={{ color: "#7060E1" }}
    ...
    <React.Fragment>
        ...
        <div className={"is-flex is-justify-content-center mt-6"}>
          <div>
            ...
            <p className={"control"}>
              <button
                className={
                  "button has-text-white is-fullwidth background-linear-land"
                }
      ...
      >
        <div className="container has-text-centered">
          <p className="is-size-3 has-text-weight-bold has-text-dark">
            How it works
          </p>
          <div className={"is-flex is-justify-content-center mt-6"}>
            <a
              className={
                "button is-primary " +
                (selectedTab == "TRAVELERS" ? "is-underlined" : "is-inverted")
              }
              onClick={() => setSelectedTab("TRAVELERS")}
            >
              Travelers
            </a>
            <a
              className={
                "button is-primary " +
                (selectedTab == "HOSTS" ? "is-underlined" : "is-inverted")
              }
        ...
        {selectedTab == "HOSTS" ? (
          ...
          <TravelerStepsSection />
        )}
      </section>
      <section className={"mt-6 p-5"} id={"forms"}>
        <div
          className={"columns is-centered mt-6"}
          style={{ position: "relative" }}
        >
          <img
            style={{
          ...
          <div
            style={{
              backgroundColor: "rgba(136, 112, 249, 0.05)",
              borderRadius: "16px",
          ...
          >
            <div className={"is-flex is-justify-content-center mt-6"}>
              <div>
                <p
                  ...
                  style={{ color: "#383350" }}
                >
                  Fill out the form and get a free subscription for 1 year!
                </p>
              </div>
            </div>
            ...
            <div className="container has-text-centered">
              <div className={"is-flex is-justify-content-center mt-6"}>
                <a
                  className={
                    "button mr-1 is-primary " +
                    (selectedSubTab == "TRAVELERS"
                      ? "is-underlined"
                      : "is-inverted")
                  }
                  onClick={() => setSelectedSubTab("TRAVELERS")}
                >
                  Travelers
                </a>
                <a
                  className={
                    "button ml-1 is-primary " +
                    (selectedSubTab == "HOSTS"
                      ? "is-underlined"
                      : "is-inverted")
                  }
                  onClick={() => setSelectedSubTab("HOSTS")}
                >
                  Hosts
                </a>
              </div>
            ...
            {selectedSubTab == "HOSTS" ? (
              <HostSubscriptionComponent />
            ) : (
              <TravelerSubscriptionComponent />
            )}
            <p className={"mt-4 has-text-centered"}>
              The <strong>Number 1</strong> Work and Travel Community is
